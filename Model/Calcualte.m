function [Minority,Majority,sub_error_min,sub_error_ma,Fair_SP] = Calcualte(prediction_label,test_label,loop,DataSample,randomset)
...
Fair_SP = abs(ratio_Minority - ratio_Majority); 